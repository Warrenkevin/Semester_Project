...
```
### Pander
##### Once the data was cleaned up a bit I used the pander package so I could use the mutuate(). Mutate is a package that allows you to add new variables while preserving others. Here I was able to create new columns of log10 that I needed for the replication assignment.
...
![log10/log10 (A) TTSA v. SL, (B) RTSA v. BM, (C) RTSA v. CV](https://raw.githubusercontent.com/Warrenkevin/Semester_Project/main/Screen%20Shot%202021-12-08%20at%209.50.48%20PM.png) 
```{r}
library(ggplot2)
